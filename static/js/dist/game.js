...
class ChatField {
    ...
    show_history() {
        ...
        this.func_id = setTimeout(function() {  //show 3s后关闭
...
class AcGamePlayground {
    ...
    show(mode) {  //打开playground界面
        ...
        if (mode === "single mode")
            for (let i = 0; i < 5; i++) {
                this.players.push(new Player(this, this.width / 2 / this.scale, 0.5, 0.05, this.get_random_color(), 0.15, "robot", this.root.settings.username, this.root.settings.photo));
...
`);
    ...
    acwing_login() {
    	$.ajax({
            url: "https://app2433.acapp.acwing.com.cn/settings/acwing/web/apply_code",
            type: "GET",
